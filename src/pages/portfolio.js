                ...
                <Container>
                    ...
                    <Grid gap={50} vertical="stretch">
                        ...
                        <WDContent>
                            ...
                            <WDDescription>
                                Excellent work has been done on developing the site for AmeriFreight, a reliable auto transport company in Georgia, USA. AmeriFreight is an auto transport broker that works with a network of reliable carriers to help consumers transport their cars and other vehicles across the lower 48 states, Canada and a few other select locations.
                            </WDDescription>
                            <WDDescription>
                                The company can ship motorcycles, automobiles, trailers, RVs, boats, classic cars and trucks. You can use AmeriFreight’s rate calculator on the website to get a better idea of how much it will cost to ship your vehicle.
                            </WDDescription>
                        </WDContent>
                    </Grid>
                </Container>
